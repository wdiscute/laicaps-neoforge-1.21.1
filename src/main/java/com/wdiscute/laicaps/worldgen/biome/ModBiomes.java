package com.wdiscute.laicaps.worldgen.biome;


import com.wdiscute.laicaps.Laicaps;
import com.wdiscute.laicaps.worldgen.ModPlacedFeatures;
...
public class ModBiomes {
    public static final ResourceKey<Biome> TEST_BIOME = ResourceKey.create(Registries.BIOME,
            ResourceLocation.fromNamespaceAndPath(Laicaps.MOD_ID, "test_biome"));
    ...
    public static Biome testBiome(BootstrapContext<Biome> context) {
        ...
        //OverworldBiomes.java for more info on vanilla biomes
