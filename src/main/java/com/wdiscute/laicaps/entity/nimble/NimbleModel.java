...
public class NimbleModel<T extends NimbleEntity> extends HierarchicalModel<T>
{
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition body = root.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -2.0F, -3.0F, 5.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -2.75F, 0.0F));

        PartDefinition feetBR = body.addOrReplaceChild("feetBR", CubeListBuilder.create().texOffs(4, 16).addBox(-0.5F, -1.25F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.25F, 2.0F, 1.75F));

        PartDefinition feetBL = body.addOrReplaceChild("feetBL", CubeListBuilder.create().texOffs(0, 16).addBox(-0.5F, -1.25F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(1.25F, 2.0F, 1.75F));

        PartDefinition feetFL = body.addOrReplaceChild("feetFL", CubeListBuilder.create().texOffs(12, 13).addBox(-0.5F, -1.25F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(1.25F, 2.0F, -2.0F));

        PartDefinition feetFR = body.addOrReplaceChild("feetFR", CubeListBuilder.create().texOffs(8, 16).addBox(-0.5F, -1.25F, -0.25F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.25F, 2.0F, -2.25F));

        PartDefinition EarL = body.addOrReplaceChild("EarL", CubeListBuilder.create(), PartPose.offset(2.0F, -2.0F, -2.0F));
        ...
        PartDefinition EarR = body.addOrReplaceChild("EarR", CubeListBuilder.create(), PartPose.offset(-2.0F, -2.0F, -2.0F));
        ...
        PartDefinition Tail = body.addOrReplaceChild("Tail", CubeListBuilder.create(), PartPose.offset(-0.5F, 1.5F, 3.0F));

        PartDefinition tail_r1 = Tail.addOrReplaceChild("tail_r1", CubeListBuilder.create().texOffs(10, 10).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.75F, 0.0F, -0.3054F, 0.0F, 0.0F));

        PartDefinition snout = body.addOrReplaceChild("snout", CubeListBuilder.create().texOffs(0, 10).addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.5F, 1.25F, -3.5F));

        PartDefinition furright = body.addOrReplaceChild("furright", CubeListBuilder.create(), PartPose.offset(0.0F, -2.0F, 0.0F));
        ...
        PartDefinition furleft = body.addOrReplaceChild("furleft", CubeListBuilder.create(), PartPose.offset(0.0F, -2.0F, 0.0F));
        ...
        PartDefinition furback = body.addOrReplaceChild("furback", CubeListBuilder.create(), PartPose.offset(0.0F, -2.0F, 3.0F));
        ...
        PartDefinition furtop = body.addOrReplaceChild("furtop", CubeListBuilder.create(), PartPose.offset(0.0F, -2.0F, 0.0F));
    ...
    public void setupAnim(NimbleEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
    {
        ...
        this.animateWalk(NimbleAnimations.WALK, limbSwing, limbSwingAmount, 3f, 1f);
        this.animate(entity.idleAS, NimbleAnimations.IDLE, ageInTicks, 1f);
        this.animate(entity.eatingAS, NimbleAnimations.EATING, ageInTicks, 1f);
        this.animate(entity.rollLeftAS, NimbleAnimations.ROLL_LEFT, ageInTicks, 1f);
        this.animate(entity.rollRightAS, NimbleAnimations.ROLL_RIGHT, ageInTicks, 1f);
