...
public class MoonrayAnimations
{
    ...
    public static final AnimationDefinition SWIM = AnimationDefinition.Builder.withLength(4.0F).looping()
            ...
            .addAnimation("back", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    ...
                    new Keyframe(1.0F, KeyframeAnimations.posVec(0.0F, 2.0F, -0.75F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(2.0F, KeyframeAnimations.posVec(0.0F, 0.25F, -0.25F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(3.0F, KeyframeAnimations.posVec(0.0F, -1.75F, -0.5F), AnimationChannel.Interpolations.CATMULLROM),
