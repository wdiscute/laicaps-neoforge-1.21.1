...
public class ModBoatEntity extends Boat {
    ...
    public Item getDropItem() {
        return switch (getModVariant()) {
            case OAKHEART -> ModItems.OAKHEART_BOAT.get();
            case OAKROOT -> ModItems.OAKROOT_BOAT.get();
        };
    }
    ...
    public static enum Type implements StringRepresentable {
        OAKHEART(ModBlocks.OAKHEART_PLANKS.get(), "oakheart"),
        OAKROOT(ModBlocks.OAKROOT_PLANKS.get(), "oakroot");
        ...
        public static ModBoatEntity.Type byName(String pName) {
            return CODEC.byName(pName, OAKHEART);
        }
    }
}
