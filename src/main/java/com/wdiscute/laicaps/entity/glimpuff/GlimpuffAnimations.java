...
public class GlimpuffAnimations
{
        ...
        public static final AnimationDefinition FULL_SWIM = AnimationDefinition.Builder.withLength(0.0F)
                .addAnimation("belly", new AnimationChannel(AnimationChannel.Targets.POSITION,
                        new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, -0.9F, -0.2F), AnimationChannel.Interpolations.LINEAR)
                ))
                .addAnimation("belly", new AnimationChannel(AnimationChannel.Targets.SCALE,
                        new Keyframe(0.0F, KeyframeAnimations.scaleVec(1.4F, 1.3F, 1.1F), AnimationChannel.Interpolations.LINEAR)
                ))
                .build();
}
