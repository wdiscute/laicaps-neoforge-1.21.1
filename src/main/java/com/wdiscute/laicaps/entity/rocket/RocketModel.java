...
public class RocketModel<T extends RocketEntity> extends HierarchicalModel<T>
{
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition rocketright = shipmain.addOrReplaceChild("rocketright", CubeListBuilder.create().texOffs(126, 176).addBox(19.0F, -92.0F, -10.0F, 17.0F, 32.0F, 15.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(30, 245).addBox(24.0F, -99.0F, -5.0F, 5.0F, 11.0F, 5.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition cube_r1 = rocketright.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(70, 250).addBox(-1.3132F, -6.9254F, -1.0F, 5.0F, 14.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(22.0F, -103.0F, -3.0F, 0.0F, 0.0F, -0.5672F));
        ...
        PartDefinition rocketleft = shipmain.addOrReplaceChild("rocketleft", CubeListBuilder.create().texOffs(190, 176).addBox(14.0F, -92.0F, -10.0F, 17.0F, 32.0F, 15.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(50, 245).addBox(18.0F, -99.0F, -5.0F, 5.0F, 11.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(-67.0F, 49.0F, 17.0F));

        PartDefinition cube_r2 = rocketleft.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(86, 250).addBox(-1.3132F, -6.9254F, -1.0F, 5.0F, 14.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(23.0F, -103.0F, -3.0F, 0.0F, 0.0F, 0.5672F));

        PartDefinition feetright = shipmain.addOrReplaceChild("feetright", CubeListBuilder.create().texOffs(32, 225).addBox(-8.0F, 10.0F, 9.0F, 8.0F, 2.0F, 8.0F, new CubeDeformation(0.0F))
                .texOffs(244, 233).addBox(-22.0F, 10.0F, 9.0F, 8.0F, 2.0F, 8.0F, new CubeDeformation(0.0F))
                .texOffs(32, 235).addBox(-14.0F, -2.0F, 9.0F, 8.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(-14.0F, 2.0F, 5.5F));

        PartDefinition cube_r3 = feetright.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(126, 250).addBox(-10.0F, -11.0F, 2.0F, 3.0F, 17.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-7.5F, 10.25F, 9.5F, 0.0F, 0.0F, 0.5236F));

        PartDefinition cube_r4 = feetright.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(102, 250).addBox(-10.0F, -11.0F, 2.0F, 3.0F, 17.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 1.25F, 9.5F, 0.0F, 0.0F, -0.5236F));

        PartDefinition feetleft = shipmain.addOrReplaceChild("feetleft", CubeListBuilder.create().texOffs(244, 243).addBox(-1.0F, -2.0F, 9.0F, 8.0F, 2.0F, 8.0F, new CubeDeformation(0.0F))
                .texOffs(0, 235).addBox(-8.0F, -14.0F, 9.0F, 8.0F, 2.0F, 8.0F, new CubeDeformation(0.0F))
                .texOffs(234, 131).addBox(-14.0F, -2.0F, 9.0F, 8.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(29.0F, 14.0F, 5.5F));

        PartDefinition cube_r5 = feetleft.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(114, 250).addBox(-10.0F, -11.0F, 2.0F, 3.0F, 17.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5F, -1.75F, 9.5F, 0.0F, 0.0F, 0.5236F));

        PartDefinition cube_r6 = feetleft.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(252, 97).addBox(-10.0F, -11.0F, 2.0F, 3.0F, 17.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(7.5F, -10.75F, 9.5F, 0.0F, 0.0F, -0.5236F));

        PartDefinition feetfront = shipmain.addOrReplaceChild("feetfront", CubeListBuilder.create().texOffs(0, 225).addBox(-14.0F, -2.0F, 9.0F, 8.0F, 2.0F, 8.0F, new CubeDeformation(0.0F))
                .texOffs(244, 223).addBox(-14.0F, -23.0F, 8.0F, 8.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(10.0F, 14.0F, -35.0F));
        ...
        PartDefinition cube_r8 = feetfront.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(250, 29).addBox(-10.0F, -11.0F, 2.0F, 3.0F, 12.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.4F, -20.75F, 15.0F, 2.4876F, -0.0266F, -0.0346F));

        PartDefinition cube_r9 = feetfront.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(0, 253).addBox(-10.1504F, -11.5F, 1.1471F, 3.0F, 16.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.5F, -3.75F, 11.0F, 0.5303F, -0.151F, -0.0879F));
        ...
        PartDefinition cockpitdecorations = cockpit.addOrReplaceChild("cockpitdecorations", CubeListBuilder.create().texOffs(224, 66).addBox(-25.0F, -2.0F, -9.0F, 5.0F, 9.0F, 10.0F, new CubeDeformation(0.0F))
                .texOffs(252, 117).addBox(-14.0F, -2.0F, -8.0F, 3.0F, 9.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(116, 208).addBox(-23.0F, -5.0F, -7.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(116, 204).addBox(-24.0F, -2.0F, -8.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(11.0F, 6.0F, -1.0F));
