...
public class RocketAnimation {
    ...
    public static final AnimationDefinition DOOR_OPEN = AnimationDefinition.Builder.withLength(4.0F)
    ...
    public static final AnimationDefinition DOOR_CLOSE = AnimationDefinition.Builder.withLength(4.0F)
            .addAnimation("doorbottom", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            ...
            .addAnimation("doortop", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(-179.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(2.0F, KeyframeAnimations.degreeVec(-179.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(3.9583F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
            ))
            .addAnimation("doortop", new AnimationChannel(AnimationChannel.Targets.POSITION,
