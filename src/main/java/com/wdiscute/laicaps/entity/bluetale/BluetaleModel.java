...
public class BluetaleModel<T extends BluetaleEntity> extends HierarchicalModel<T>
{
    ...
    public BluetaleModel(ModelPart root) {
    ...
    @Override
    public void setupAnim(BluetaleEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
    {
