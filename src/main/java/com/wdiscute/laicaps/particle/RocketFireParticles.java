...
public class RocketFireParticles extends TextureSheetParticle
{
    protected RocketFireParticles(ClientLevel level, double x, double y, double z, SpriteSet spriteSet)
    {
        super(level, x, y, z);
    ...
    public void tick()
    {
        ...
        if(random.nextFloat() > 0.6)
        {
            ...
            if(random.nextFloat() > 0.95) this.level.addParticle(ParticleTypes.SOUL_FIRE_FLAME, this.x + random.nextFloat() * 2 - 1, this.y, this.z  + random.nextFloat() * 2 - 1, this.xd, this.yd, this.zd);
        }
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType>
    {
        ...
        {
            return new RocketFireParticles(clientLevel, x, y, z, this.spriteSet);
        }
    }
