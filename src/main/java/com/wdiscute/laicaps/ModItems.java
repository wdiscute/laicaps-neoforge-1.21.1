...
public class ModItems
{
    ...
    public static final DeferredItem<Item> ASTRONOMY_NOTEBOOK = ITEMS.register(
            "astronomy_notebook",
    ...
    public static final DeferredItem<Item> BASIC_MICROCHIP =
            ITEMS.register(
                    "basic_microchip", () -> new Item(new Item.Properties()
                            .rarity(Rarity.RARE)
                    ));
    ...
    public static final DeferredItem<Item> ADVANCED_MICROCHIP =
            ITEMS.register(
                    "advanced_microchip", () -> new Item(new Item.Properties()
                            .rarity(Rarity.RARE)
                    ));
    ...
    public static final DeferredItem<Item> ROCKET =
            ITEMS.register(
                    "rocket", () -> new RocketItem(new Item.Properties()
                            .rarity(Rarity.EPIC)
                            .stacksTo(1)
                    ));
    ...
    public static final DeferredItem<Item> EMBER =
            ITEMS.register(
                    "ember", () -> new Item(new Item.Properties()
                            .rarity(Rarity.RARE)
                    ));
    public static final DeferredItem<Item> ASHA =
            ITEMS.register(
                    "asha", () -> new Item(new Item.Properties()
                            .rarity(Rarity.RARE)
                    ));
    public static final DeferredItem<Item> OVERWORLD =
            ITEMS.register(
                    "overworld", () -> new Item(new Item.Properties()
                            .rarity(Rarity.RARE)
                    ));
    public static final DeferredItem<Item> LUNAMAR =
            ITEMS.register(
                    "lunamar", () -> new Item(new Item.Properties()
                            .rarity(Rarity.RARE)
                    ));
